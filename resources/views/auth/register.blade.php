<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Form Container -->
        <div class="relative z-10 flex items-center justify-center w-full h-screen overflow-hidden">
            <div class="w-full max-w-md bg-black/80 rounded-xl shadow-2xl p-8 text-white space-y-4">
            ...
            <div class="flex justify-center mb-6">
                ...
                <!-- Actions -->
                <div class="flex items-center justify-end mt-4"  class="text-white" >
